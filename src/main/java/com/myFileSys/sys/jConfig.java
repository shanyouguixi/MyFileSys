...
import com.myFileSys.common.model._MappingKit;
import com.myFileSys.index.CheckInterceptor;
import com.myFileSys.sys.RoutesConfig;
...
public class jConfig extends JFinalConfig {
	public static final String BASEPATN="/rs";
	/**
	...
	public void configConstant(Constants me) {
		...
		me.setMaxPostSize(1024*1024*600);
	}
	...
	public void configInterceptor(Interceptors me) {
		...
		me.add(new ErrorIntercepter());
//		me.addGlobalServiceInterceptor(new TxByActionKeyRegex("/trans.*"));
